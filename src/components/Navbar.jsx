            ...
            <li key={link.id}>
              <button
                ...
                style={{
                  ...
                  backgroundColor: activeSection === link.id ? 'rgba(79,142,255,0.1)' : 'transparent',
                  transition: 'all 0.2s ease',
                }}
                onMouseEnter={(e) => {
                  if (activeSection !== link.id) e.target.style.color = '#f0f4ff';
                }}
                onMouseLeave={(e) => {
                  if (activeSection !== link.id) e.target.style.color = '#8892b0';
                }}
              >
                {link.label}
              </button>
